...
namespace SocialBarbaWeb.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // GET: /Account/Login
        [AllowAnonymous]
        public ActionResult customizedLogin(string returnUrl)
        {
            GerarPerfisDeExemplo.Executar();
        ...
        public async Task<ActionResult> customizedLogin(LoginViewModel model, string returnUrl)
        {
        ...
        public ActionResult LogOff()
        {
            ...
            return RedirectToAction("customizedLogin", "Account");
        }
